...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        # Добавляем компоненты SidebarComponent, NavbarComponent
        ...
        # Карточка курса
        self.course_title = page.get_by_test_id(
            'course-widget-title-text')
        self.course_image = page.get_by_test_id(
            'course-preview-image')
        self.course_max_text = page.get_by_test_id(
            'course-max-score-info-row-view-text')
        self.course_min_text = page.get_by_test_id(
        ...
        self.course_edit_menu_button = page.get_by_test_id(
            'course-view-edit-menu-item'
        )
        self.course_delete_menu_button = page.get_by_test_id(
